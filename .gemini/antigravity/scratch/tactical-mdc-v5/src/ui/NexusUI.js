    ...
    renderLayout() {
        this.container.innerHTML = `
            <div class="mdc-container">
                ...
                <main class="mdc-main">
                    <nav class="side-nav">
                        <a href="#" class="nav-item active" data-view="dashboard"><i data-lucide="layout-dashboard"></i> DASHBOARD</a>
                        <a href="#" class="nav-item" data-view="procesado"><i data-lucide="file-text"></i> PROCESADO</a>
                        <a href="#" class="nav-item" data-view="radio"><i data-lucide="radio"></i> RADIO</a>
                        <a href="#" class="nav-item" data-view="comunicados"><i data-lucide="message-square"></i> COMUNICADOS</a>
                        <a href="#" class="nav-item" data-view="force"><i data-lucide="shield-alert"></i> USO DE LA FUERZA</a>
                        <a href="#" class="nav-item" data-view="validator"><i data-lucide="shield-check"></i> VALIDAR FUERZA</a>
                        <a href="#" class="nav-item" data-view="jurisprudence"><i data-lucide="library"></i> JURISPRUDENCIA</a>
                        <a href="#" class="nav-item" data-view="smith"><i data-lucide="microscope"></i> S.M.I.T.H.</a>
                        <a href="#" class="nav-item" data-view="intel"><i data-lucide="radar"></i> INTEL</a>
                    </nav>
