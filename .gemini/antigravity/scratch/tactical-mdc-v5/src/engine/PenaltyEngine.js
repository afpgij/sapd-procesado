...
/**
 * 🛡️ PROTECTED CORE MODULE - NEXUS PENALTY ENGINE v10.0
...
export const PENALTY_DATA = {
    ...
    "v-wrong-way": { name: "Conducción Lado Incorrecto", jail: 0, fine: 125, cat: "Infracción", cumulative: true },
    "v-jaywalking": { name: "Peatón fuera de paso", jail: 0, fine: 50, cat: "Infracción", cumulative: true },
    "v-sidewalk": { name: "Circular por la Acera", jail: 0, fine: 100, cat: "Infracción", cumulative: true },
    "v-no-plates": { name: "No mostrar Matrículas", jail: 10, fine: 500, cat: "Delito Leve A", cumulative: false },
    ...
    "v-weight-limit": { name: "Exceso de Peso Comercial", jail: 0, fine: 150, cat: "Infracción", cumulative: true },
    ...
    "p-incendio": { name: "Incendio Provocado", jail: 20, fine: 500, cat: "Delito Grave D", cumulative: false },
    "p-extortion": { name: "Extorsión", jail: 15, fine: 700, cat: "Delito Grave D", cumulative: false },
    "p-embezzlement": { name: "Malversación / Apropiación", jail: 30, fine: 800, cat: "Delito Grave C", cumulative: false },
    "p-gov-theft": { name: "Robo a Empleado Gubernamental", jail: 45, fine: 2500, cat: "Delito Grave B", cumulative: false, reminder: "⚠️ ELEMENTOS DEL EQUIPO OFICIAL ROBADOS" },
    "p-animal-cruelty": { name: "Crueldad Animal", jail: 30, fine: 950, cat: "Delito Grave D", cumulative: false },
    ...
    "p-larceny": { name: "Hurto (Propiedad)", jail: 10, fine: 700, cat: "Delito Leve B", cumulative: false },
    "p-larceny-grand": { name: "Hurto Mayor (+$3k)", jail: 15, fine: 500, cat: "Delito Grave D", cumulative: false },
    "p-threats": { name: "Amenazas Criminales", jail: 15, fine: 500, cat: "Delito Leve A", cumulative: false },
    "p-stalking": { name: "Acoso", jail: 20, fine: 700, cat: "Delito Grave B", cumulative: false },
    "p-sexual-assault": { name: "Agresión Sexual", jail: 60, fine: 2000, cat: "Delito Leve B", cumulative: false },
    "p-forced-intox": { name: "Intoxicación Forzada", jail: 15, fine: 3000, cat: "Delito Grave D", cumulative: false },
    "p-false-imprisonment": { name: "Privación Libertad", jail: 12, fine: 425, cat: "Delito Leve A", cumulative: false },
    "p-desecration": { name: "Profanar Cadáver", jail: 5, fine: 50, cat: "Delito Grave D", cumulative: false },
    ...
    "p-abuse-911": { name: "Uso Indebido del 911", jail: 0, fine: 150, cat: "Delito Leve C", cumulative: true },
    "p-medical-illegal": { name: "Ejercicio Ilegal Medicina", jail: 40, fine: 2500, cat: "Delito Grave D", cumulative: false },
    "p-law-illegal": { name: "Ejercicio Ilegal Abogacía", jail: 15, fine: 400, cat: "Delito Leve A", cumulative: false },
    "p-escape-custody": { name: "Fuga de la Custodia", jail: 10, fine: 350, cat: "Delito Grave D", cumulative: false, reminder: "⚠️ EL SUJETO ESTABA BAJO CUSTODIA (ESPOSADO)" },
